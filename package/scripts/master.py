...
class Master(Script):
  def install(self, env):
  	...
  	if not os.path.exists(params.temp_file):
  	  ...
  	  Execute('rm redis.conf', user=params.redis_user)
  	  ...
  	  Execute('cp redis-server /usr/local/bin', user=params.redis_user)
  	  Execute('cp redis.conf /etc/redis', user=params.redis_user)
  	  Execute('mv redis-server /etc/init.d', user=params.redis_user)
