...
class Master(Script):
  def install(self, env):
  	...
  	if not os.path.exists(params.temp_file):
  	  ...
  	  Execute('wget https://raw.githubusercontent.com/harinagalla/redis-ambari/patch-2/configuration/redis-server'+ params.redis_log_file, user=params.redis_user)
  	  Execute('rm redis.conf')
  	  Exwcute('wget https://raw.githubusercontent.com/harinagalla/redis-ambari/patch-2/configuration/redis.conf'+ params.redis_log_file, user=params.redis_user)
